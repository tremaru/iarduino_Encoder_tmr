...
iarduino_Encoder_tmr enc_1(pin_1A,pin_1B);       //  Создаём объект enc_1 для работы с 1 энкодером указывая (№ вывода A, № вывода B)
iarduino_Encoder_tmr enc_2(pin_2A,pin_2B);       //  Создаём объект enc_2 для работы с 2 энкодером указывая (№ вывода A, № вывода B)
